...
class Homepage extends Component {
  ...
  async loadCardList(url) {
    ...
    if (url === API_TOP_RATED_VILLA) this.setState({ cards1: response });
    ...
    return (
      ...
      <React.Fragment>
        ...
        >
          ...
          >
            <div
              className={"pt-5 mb-5 d-flex ml-auto mr-auto d-flex flex-column"}
              style={{ width: "fit-content" }}
            >
              <h4
                className={" mt-auto mb-4 ml-4"}
            ...
            <div
              className={"pt-5 mt-5 d-flex ml-auto mr-auto d-flex flex-column"}
              style={{ width: "fit-content" }}
            >
              <h4
                className={" mt-auto mb-4 ml-4"}
