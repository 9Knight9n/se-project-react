    ...
    render() { 
        return ( 
            <div className="terms-main">
                ...
                Please read these Terms and Conditions carefully before using the <a href="#" target="blank"> http://www.SweetHome.com </a>
                ...
                <b style={{color: "red"}}>
                    ...
                    By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may
                ...
                <b>Purchases</b>
                <p>
                    If you wish to purchase any product or service made available through the Service , you may be asked to supply certain
                ...
                other Content. You are responsible for the …
                </p>
