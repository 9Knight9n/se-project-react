    ...
    constructor(props) {
        ...
        this.state = {
            ...
            facilities: [
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="air-conditioner"
                             role="img"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="refrigerator" role="img"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="phone-rotary" role="img"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="hdd" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="hat-chef" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="tv" role="img"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="couch" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="tint" role="img"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="microwave" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="swimming-pool" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="car-garage" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="wifi" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="oven" role="img"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="fireplace" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                ...
                {
                    src:
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="toilet" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
                ...
                <div className="villaProfile-body">
                    <div className="villaProfile-attributes row">
                        <div className="villaProfile-gallery col-xl-6">
                            <div className="mb-4 row">
                                <div className="img1 col">
                                    <img onClick={this.showGallary} alt="villa-image"
                            ...
                            <div className="row">
                                <div className="img3 col">
                                    ...
                                    <button onClick={this.showGallary} className="btn btn-light">Show all photos
                                    </button>
                                </div>
                        ...
                        <div className="villaProfile-details ml- col-xl-6 mt-2">
                            ...
                            <div className="villaProfile-placeDetail row">
                                <div className="villaProfile-hostAvatar col-xl-1 col-lg-1 col-md-1 col-sm-2 col-3">
                                    <img alt="profile-image"
                                         src={this.state.owner_image ? API_BASE_URL.substring(0, API_BASE_URL.length - 1) + this.state.owner_image : sampleProfileImg}/>
                                </div>
                            ...
                            <div className="villaProfile-detail mt-2 row">
                                ...
                                <div
                                    className="villaProfile-placeDescription villaProfile-title col-xl-11 col-lg-11 col-md-11 col-sm-10 col-8">
                                    <h5>About villa </h5>
                            ...
                            <div className="villaProfile-detail mt-2 row">
                                ...
                                <div
                                    className="villaProfile-placeCapacity col-xl-11 col-lg-11 col-md-11 col-sm-10 col-8">
                                    <h5>Capacity </h5>
                                    <p>Normal : {this.state.placeNormalCapacity} , Maximum
                                        : {this.state.placeMaxCapacity}</p>
                                </div>
                            </div>
                            ...
                            <div className="villaProfile-detail mt-2 row">
                                ...
                                <div className="villaProfile-bedrooms col-xl-11 col-lg-11 col-md-11 col-sm-10 col-8">
                                    <h5>Villa space </h5>
                                    <p>Bedrooms : {this.state.numOfBedrooms} , bathrooms : {this.state.numOfBathrooms} ,
                                        Showers : {this.state.numOfShowers}</p>
                                </div>
                            </div>
                            ...
                            <div className="villaProfile-detail mt-2 row">
                                ...
                                <div className="villaProfile-beds col-xl-11 col-lg-11 col-md-11 col-sm-10 col-8">
                                    <h5>Bed set </h5>
                                    <p>DoubleBeds : {this.state.numOfDoubleBeds} , SignleBeds
                                        : {this.state.numOfSingleBeds}</p>
                                </div>
                            </div>
                            ...
                            <div className="row ml-2 mb-2">
                                {this.state.facilities.map((facility =>
                                        <div key={facility.id}
                                            ...
                                            <div className="row">
                                                <div id={!facility.isAvailable ? "villaProfile-facility-disable" : ''}
                                                     className="pr-2 pl-2 pt-4 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6 villaProfile-facilityIcons">{facility.src}</div>
                                                <div id={!facility.isAvailable ? "villaProfile-facility-disable" : ''}
                                                     className="col-xl-9 col-lg-9 col-md-8 col-sm-6 col-6 pr-2 pl-2 d-flex align-items-end">{facility.label}</div>
                                            </div>
                                        </div>
                                ))}
                            </div>
                    ...
                    <Switch>
                        <Route path="/villa/villaProfile/reserve/">
                            <Reserve place_id={this.state.id} place_address={this.state.place_address}
                                     owner_phoneNumber={this.state.owner_phoneNumber} placeOwner={this.state.placeOwner}
                                     placeMaxCapacity={this.state.placeMaxCapacity} PlacePrice={this.state.placePrice}/>
                        </Route>
                        <Route path="/villa/villaProfile/reserve/1/">
                            <Reserve1 placeMaxCapacity={this.state.placeMaxCapacity}
