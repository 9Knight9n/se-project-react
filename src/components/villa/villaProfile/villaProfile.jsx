                            ...
                            <div className="row ml-2 mb-2">
                                {this.state.facilities.map((facility=>
                                    <div key={facility.id} className="villaProfile-facilityOptions col-xl-4 col-lg-4 col-md-4 col-sm-8">
                                        <div className="row">
                                            <div id={!facility.isAvailable?"villaProfile-facility-disable":''} className="pr-2 pl-2 pt-4 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6 villaProfile-facilityIcons">{facility.src}</div>
                                            <div id={!facility.isAvailable?"villaProfile-facility-disable":''} className="col-xl-9 col-lg-9 col-md-8 col-sm-6 col-6 pr-2 pl-2 d-flex align-items-end">{facility.label}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
