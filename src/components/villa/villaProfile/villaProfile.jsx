        ...
        <div className="villaProfile-body">
          ...
          <div className="villaProfile-rules row mt-4">
            <div className="col-xl-6">
              ...
              <div className="ml-2">
                <p>1. You can not smoke in villa.</p>
                <p>2. Pets are not allowed in villa.</p>
                <p>
                  3. The number of passengers must be less than maximum
                  capacity.
                </p>
                {/* <p>
            ...
            <div className="col-xl-6">
              ...
              <div className="ml-2">
                <p>1. 3 days ahead of schedule nothing will be returned.</p>
                <p>
                  2. 7 days ahead of schedule 30% of price will be returned.
                </p>
                <p>
                  3. More than 7 days ahead of schedule 100% of price will be
                  returned.
                </p>
                {/* <p>
                                    4. You can not smoke in villa.
